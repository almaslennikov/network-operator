...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *ClusterNodeSelectorSpec) DeepCopyInto(out *ClusterNodeSelectorSpec) {
	*out = *in
	if in.ClusterNodeSelector != nil {
		in, out := &in.ClusterNodeSelector, &out.ClusterNodeSelector
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new ClusterNodeSelectorSpec.
func (in *ClusterNodeSelectorSpec) DeepCopy() *ClusterNodeSelectorSpec {
	if in == nil {
		return nil
	}
	out := new(ClusterNodeSelectorSpec)
	in.DeepCopyInto(out)
	return out
}
...
func (in *NicClusterPolicySpec) DeepCopyInto(out *NicClusterPolicySpec) {
	*out = *in
	if in.ClusterNodeAffinity != nil {
		in, out := &in.ClusterNodeAffinity, &out.ClusterNodeAffinity
		*out = new(v1.NodeAffinity)
		(*in).DeepCopyInto(*out)
	}
	in.ClusterNodeSelectorSpec.DeepCopyInto(&out.ClusterNodeSelectorSpec)
